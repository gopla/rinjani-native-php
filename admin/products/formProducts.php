...
if ($method == 'add') {
    ...
    <form action="products/controllerProducts.php?act=store" method="post" enctype="multipart/form-data">
        ...
        <div class="form-item">
            ...
            <select name="var_cat" class="form-input" required>
        ...
        <div class="form-item">
            ...
            <input type="number" name="var_price" class="form-input" required>
        </div>
        <div class="form-item">
            <label for="var_stock">Stock</label>
            <input type="number" name="var_stock" class="form-input" required>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <input type="file" name="var_img" class="form-input" required>
        </div>
        <div class="form-item">
...
<?php
    ...
    while ($row = mysqli_fetch_array($query)) {
        ...
        <form action="products/controllerProducts.php?act=update" method="post" enctype="multipart/form-data">
            ...
            <div class="form-item">
                <label for="var_name">Name</label>
                <input type="text" name="var_name" value="<?php echo $row[2] ?>" class="form-input" required>
            </div>
            <div class="form-item">
                <label for="var_cat">Category</label>
                <select name="var_cat" class="form-input" required>
            ...
            <div class="form-item">
                <label for="var_price">Price</label>
                <input type="number" name="var_price" value="<?php echo $row[3] ?>" class="form-input" required>
            </div>
            <div class="form-item">
                <label for="var_stock">Stock</label>
                <input type="number" name="var_stock" value="<?php echo $row[4] ?>" class="form-input" required>
            </div>
